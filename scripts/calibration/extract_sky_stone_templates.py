...
def main() -> int:
    ...
    parser.add_argument(
        "--balance-3924-source", type=Path, required=True
    )
    parser.add_argument(
        "--balance-3900-source", type=Path, required=True
    )
    parser.add_argument(
        "--combined-top-bar-source", type=Path, required=True
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
    ...
    (ensure_candidate_path(manifest_dir / "sky_stone_manifest.yaml")).write_text(
